  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "valentine-pulse": {
          "0%, 100%": { transform: "scale(1)", boxShadow: "0 0 0 0 hsl(345 100% 58% / 0.4)" },
          "50%": { transform: "scale(1.03)", boxShadow: "0 0 20px 8px hsl(345 100% 58% / 0)" },
        },
        "float": {
      ...
      animation: {
        ...
        "valentine-pulse": "valentine-pulse 2s ease-in-out infinite",
