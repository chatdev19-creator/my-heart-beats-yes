      ...
      <div className="animate-letter-reveal w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-2xl bg-card valentine-card-shadow">
        ...
        <div className="p-6 sm:p-8">
          ...
          <div className="space-y-4 text-foreground leading-relaxed text-base sm:text-lg">
            ...
            <p>You make the ordinary extraordinary. Your smile lights up even my darkest days, and your laugh is the melody I never want to stop hearing. 


I love the little things about you The way your presence alone can make my bad days feel lighter.  


The way you make me laugh when I don’t even feel like smiling.  And the way you listen, really listen, like my thoughts and dreams truly matter to you.


 Those small things might seem simple, but to me, they mean everything.


 Being with you has taught me what love really feels like—not just the exciting, happy moments, but the quiet, peaceful ones too.


  The moments where we don’t even need to talk, just being together is enough. 


The moments where I realize that no matter how hard the day is, coming back to you makes everything feel okay again.


 I don’t think I say this enough, but you mean more to me than words can ever fully explain.  


You are my comfort when I’m tired, my calm when I’m stressed, and my happiness when I need it most.  


When I think about you, my heart feels full in a way that’s hard to describe like it finally found the place it was always looking for.




 On this Valentine’s Day, I just want to promise you something simple but true I choose you Today, tomorrow, and every day I choose your smile, your heart, your dreams, and even your flaws because they are all part of the person I love.


I want to keep building memories with you, sharing laughs with you, and walking through life with you, side by side</p>
            <p> </p>
